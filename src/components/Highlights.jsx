        ...
        <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    ...
                    <p className="text-gray-300">
                        Estrutura de titânio de grau aeroespacial. O smartphone mais
                        forte e leve.
                    </p>
                </div> 
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="bg-gray-900  hover:bg-gray-800 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
